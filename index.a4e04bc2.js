 ...
 * https://modernizr.com/download/?-cssanimations-csscolumns-customelements-flexbox-history-picture-pointerevents-postmessage-sizes-srcset-webgl-websockets-webworkers-addtest-domprefixes-hasevent-mq-prefixedcssvalue-prefixes-setclasses-testallprops-testprop-teststyles !*/ !function(e, t, n) {
    function r(e, t) {
        return typeof e === t;
    }
    function o(e) {
    ...
    function i(e, t) {
        if ("object" == typeof e) for(var n in e)E(e, n) && i(n, e[n]);
            ...
            t = "function" == typeof t ? t() : t, 1 === r.length ? Modernizr[r[0]] = t : (!Modernizr[r[0]] || Modernizr[r[0]] instanceof Boolean || (Modernizr[r[0]] = new Boolean(Modernizr[r[0]])), Modernizr[r[0]][r[1]] = t), o([
                (t && !1 !== t ? "" : "no-") + r.join("-")
    ...
    function m(e, t, o, i) {
        ...
        for(var f, c, m, h, v, A = [
            ...
            "tspan",
            "samp"
        ]; !L.style && A.length;)f = !0, L.modElem = s(A.shift()), L.style = L.modElem.style;
    ...
    var C = [], b = t.documentElement, S = "svg" === b.nodeName.toLowerCase(), _ = "Moz O ms Webkit", x = w._config.usePrefixes ? _.toLowerCase().split(" ") : [];
    w._domPrefixes = x;
    ...
    Modernizr.addTest("websockets", R), Modernizr.addTest("cssanimations", g("animationName", "a", !0)), function() {
        ...
        for(var e, t, n = [
            ...
            "BreakAfter",
            "BreakInside"
        ], r = 0; r < n.length; r++)e = n[r].toLowerCase(), t = g("column" + n[r]), "breakbefore" !== e && "breakafter" !== e && "breakinside" !== e || (t = t || g(n[r])), Modernizr.addTest("csscolumns." + e, t);
...
//# sourceMappingURL=index.a4e04bc2.js.map
